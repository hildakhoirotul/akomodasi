                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">{{ ucwords(str_replace('_', ' ', $last->tabel)) }} <span><br>| {{ $last->created_at->shortRelativeDiffForHumans() }}</span></h5>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        ...
                                        <!-- @if(array_key_exists($last->tabel, $totalTrue))
                                        <span class="text-success small pt-1 fw-bold">OK</span> <span class="text-muted small pt-2 ps-1">{{ $totalTrue[$last->tabel] }} &nbsp;</span>
                                        @endif -->
